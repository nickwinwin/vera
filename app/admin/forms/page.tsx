    ...
    try {
      ...
      if (data && data.length > 0) {
        ...
        setTemplates([
          ...
          { id: 4, name: 'Hautsensibilit├ñt', type: 'Questionnaire', version: '1.1', status: 'active', lastUpdate: '15.01.2025' },
    ...
    <div className="space-y-8">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-brand-secondary">Verwalten Sie die rechtssicheren Vorlagen f├╝r Einwilligungserkl├ñrungen.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          ...
          >
            ...
            <p className="text-xs text-brand-muted mb-6">{template.type} ÔÇó v{template.version}</p>
