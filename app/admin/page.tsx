  ...
  const fetchData = async () => {
    try {
      ...
      setStats([
        ...
        { label: 'Monatlicher Umsatz (MRR)', value: `${totalMrr.toLocaleString('de-DE')} €`, icon: CreditCard, trend: 'Aktuell', trendUp: true },
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-brand border border-green-100">
              ...
              <div>
                ...
                <p className="text-xs text-green-600">Supabase läuft</p>
              </div>
            </div>
            <div className="flex items-center gap-3 p-4 bg-green-50 rounded-brand border border-green-100">
              <div className="w-3 h-3 rounded-full bg-green-500" />
