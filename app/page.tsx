        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="hidden md:flex items-center gap-10">
              ...
              <Link href="/faq" className="text-sm text-brand-secondary hover:text-brand-dark transition-colors">FAQ</Link>
              <Link href="/blog" className="text-sm text-brand-secondary hover:text-brand-dark transition-colors">Blog</Link>
              <button 
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 mb-12">
            ...
            <div className="flex gap-8 text-sm text-brand-secondary">
              <Link href="/faq" className="hover:text-brand-beige transition-colors">FAQ</Link>
              <Link href="/blog" className="hover:text-brand-beige transition-colors">Blog</Link>
